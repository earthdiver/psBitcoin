...
$passphrase1 = ""
if ( -not ( ValidateMnemonic $mnemonic1 ) ) { throw "invalid mnemonic code (1)" }
...
$passphrase2 = ""
if ( -not ( ValidateMnemonic $mnemonic2 ) ) { throw "invalid mnemonic code (2)" }
...
( $w1 = [HDWallet]::new() ).ImportExtendedKey( $Zprv1, "m/48'/0'/0'/2'", 0 )
( $w2 = [HDWallet]::new() ).ImportExtendedKey( $Zpub2, "m/48'/0'/0'/2'", 0 )
$xprv1   = $w1.GetExtendedPrivatekey( 0, $true )
$xpub1   = $w1.GetExtendedPublickey( 0, $true )
$xpub2   = $w2.GetExtendedPublickey( 0, $true )
...
( $w1 = [HDWallet]::new() ).ImportExtendedKey( $Yprv1, "m/48'/0'/0'/1'", 0 )
( $w2 = [HDWallet]::new() ).ImportExtendedKey( $Ypub2, "m/48'/0'/0'/1'", 0 )
$xprv1   = $w1.GetExtendedPrivatekey( 0, $true )
$xpub1   = $w1.GetExtendedPublickey( 0, $true )
$xpub2   = $w2.GetExtendedPublickey( 0, $true )
...
( $w1 = [HDWallet]::new() ).ImportExtendedKey( $xprv1, "m/45'", 0 )
( $w2 = [HDWallet]::new() ).ImportExtendedKey( $xpub2, "m/45'", 0 )
